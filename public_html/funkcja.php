...
<article>
  ...
  <p id="upload" class="hidden"><label>Drag & drop not supported, but you can still upload via this input field:<br><input name="item_image_ext_desc" type="file"></label></p>
